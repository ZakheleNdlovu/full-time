...
const League1Standings = () => {
    ...
    useEffect(() => {
        const getStandings = async () => {
            const response = await fetch('https://site.api.espn.com/apis/v2/sports/soccer/fra.1/standings')
            if (!response.ok) {
    ...
    return (
        <View>
            <View style={styles.headerBox}>
                ...
                <Text style={styles.text2}>League 1 Standings</Text>
            </View>
...
export default League1Standings