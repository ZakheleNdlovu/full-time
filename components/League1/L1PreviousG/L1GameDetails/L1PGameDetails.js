...
import L1PStats from './L1PStats'
import L1PEventDetails from './L1PEventDetails'
import L1PLineUps from './L1PLineUps'

const L1PGameDetails = () => {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <ScrollView style={{ height: '70%' }}>
                ...
                <View >
                    <L1PStats game={game} />
                    <L1PEventDetails game={game} />
                    <L1PLineUps game={game} />
                </View>
