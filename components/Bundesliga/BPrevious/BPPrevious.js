...
import BPrevEvents from './BPEvents'
...
const BPrevious = () => {
    ...
    useEffect(() => {
        const fetchGames = async () => {
            const response = await fetch('https://site.api.espn.com/apis/site/v2/sports/soccer/ger.1/scoreboard?dates=20250801-20260530')
            if (!response.ok) {
