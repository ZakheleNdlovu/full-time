...
import LLPStats from './LLPStats'
import LLPEventDetails from './LLPEventDetails'
import LLPLineUps from './LLPLineUps'

const LLPGameDetails = () => {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <ScrollView style={{ height: '70%' }}>
                ...
                <View >
                    <LLPStats game={game} />
                    <LLPEventDetails game={game} />
                    <LLPLineUps game={game} />
                </View>
