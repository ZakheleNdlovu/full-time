...
const EPLPTeamPlayer = ({ id, playerDet }) => {

    const [player, setPlayer] = useState([])

    useEffect(() => {
        const getTeam = async () => {
            const response = await fetch(`http://sports.core.api.espn.com/v2/sports/soccer/leagues/eng.1/seasons/2025/athletes/${id}?lang=en&region=us`)
