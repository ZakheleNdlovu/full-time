...
import EPLPrevEvents from './EPLPrevGames'
...
const EPLPrevious = () => {
    ...
    useEffect(() => {
        const fetchGames = async () => {
            const response = await fetch('https://site.api.espn.com/apis/site/v2/sports/soccer/eng.1/scoreboard?dates=20250801-20260530')
            if (!response.ok) {
