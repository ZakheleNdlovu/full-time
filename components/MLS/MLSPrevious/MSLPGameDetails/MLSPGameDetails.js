...
import MLSPStats from './MLSPStats'
import MLSPEventDetails from './MLSPEventDetails'
import MLSPLineUps from './MLSPLineUps'

const MLSPGameDetails = () => {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <ScrollView style={{ height: '70%' }}>
                ...
                <View >
                    <MLSPStats game={game} />
                    <MLSPEventDetails game={game} />
                    <MLSPLineUps game={game} />
                </View>
...
export default MLSPGameDetails