...
import MLSPrevEvents from './MLSPEvents'
...
const MLSPrevious = () => {
    ...
    useEffect(() => {
        const fetchGames = async () => {
            const response = await fetch('https://site.api.espn.com/apis/site/v2/sports/soccer/usa.1/scoreboard?dates=20250801-20260530')
            if (!response.ok) {
