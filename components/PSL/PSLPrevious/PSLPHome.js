...
import PSLPrevEvents from './PSLPEvents'
...
const PSLPrevious = () => {
    ...
    useEffect(() => {
        const fetchGames = async () => {
            const response = await fetch('https://site.api.espn.com/apis/site/v2/sports/soccer/rsa.1/scoreboard?dates=20250801-20260530')
            if (!response.ok) {
