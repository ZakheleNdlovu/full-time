...
import PSLPStats from './PSLPStats'
import PSLPEventDetails from './PSLPEventDetails'
import PSLPLineUps from './PSLPLineUp'

const PSLPGameDetails = () => {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <ScrollView style={{ height: '70%' }}>
                ...
                <View >
                    <PSLPStats game={game} />
                    <PSLPEventDetails game={game} />
                    <PSLPLineUps game={game} />
                </View>
...
export default PSLPGameDetails