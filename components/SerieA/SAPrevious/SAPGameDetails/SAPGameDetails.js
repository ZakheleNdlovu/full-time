...
import SAPStats from './SAPStats'
import SAPEventDetails from './SAPEventDetails'
import SAPLineUps from './SAPLineUps'

const SAPGameDetails = () => {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <ScrollView style={{ height: '70%' }}>
                ...
                <View >
                    <SAPStats game={game} />
                    <SAPEventDetails game={game} />
                    <SAPLineUps game={game} />
                </View>
